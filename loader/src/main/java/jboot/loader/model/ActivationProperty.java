 ...
 * 				profile. If the value field is empty, then the existence
 * 				of the named property will activate the profile,
 * 				otherwise it does a case-sensitive match against the
