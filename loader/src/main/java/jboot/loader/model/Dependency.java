...
public class Dependency {
    ...
    public Dependency(Dependency dependency) {
        if (dependency != null) {
            ...
            if (dependency.getExclusions() != null) {
            	setExclusions(new Exclusions());
            	List<Exclusion> exclusions = getExclusions().getExclusion();
            	for (Exclusion exclusion : dependency.getExclusions().getExclusion()) {
            		exclusions.add(new Exclusion(exclusion));
            	}
            }
        }
    }
    ...
    /**
     * checks that groupId and artifactId are non-null and non-empty
     * 
     * @return true when groupId and artifactId are non-null and non-empty, false otherwise.
     */
