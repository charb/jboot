 ...
 * 				profile. The missing value will be the location of a
 * 				file that needs to exist, and if it doesn't the
 * 				profile will be activated. On the other hand exists will
 * 				test for the existence of the file and if it is there
 * 				the profile will be activated.
 * 			
 * 
