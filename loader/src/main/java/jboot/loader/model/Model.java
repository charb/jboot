...
//    @XmlElement
    ...
    public static class Properties {
        ...
        public Map<String, String> getProperties() {
            ...
            for (Element property : getAny()) {
            	if (property != null  &&
            		property.getNodeName() != null &&
            		property.getFirstChild() != null &&
            		property.getFirstChild().getNodeValue() != null) {
            		propertiesMap.put(property.getNodeName(), property.getFirstChild().getNodeValue());
            	}
            }
